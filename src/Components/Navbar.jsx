...
export default function Navbar() {
  ...
  <div className="w-full px-15 py-3 grid grid-cols-3 items-center">
    ...
    <nav className="flex justify-center items-center space-x-8 font-semibold text-[14px]">
      <a href="#home" className="text-[#2563eb] border-b-2 border-[#2563eb] pb-1">
        Home
      </a>
      <a href="#course" className="text-[#8B8B8B] hover:text-gray-900 transition-colors">
        Course
      </a>
      <a href="#about" className="text-[#8B8B8B] hover:text-gray-900 transition-colors">
        About Us
      </a>
    </nav>
  ...
  <div className="px-4 py-3 flex items-center justify-between">
    ...
    {/* Contact Button */}
    <button className="bg-[#4338ca] text-white text-xs font-medium px-4 py-2 rounded-full">
      Contact
    </button>
      ...
      <nav className="block md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
        <div className="flex justify-around items-center h-16">
          ...
          {/* Mobile Home Link */}
          <a href="#home" className="flex flex-col items-center justify-center w-full h-full text-[#2563eb]">
          ...
          {/* Mobile Course Link */}
          <a href="#course" className="flex flex-col items-center justify-center w-full h-full text-gray-400 hover:text-gray-600">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {/* Mobile About Link */}
          <a href="#about" className="flex flex-col items-center justify-center w-full h-full text-gray-400 hover:text-gray-600">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
